 ...
 * permitted without authentication, while all other requests require a valid
 * JWT token.
 * </p>
 *
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	/**
	 * The JWT request filter that intercepts and validates JWT tokens on every
	 * incoming HTTP request before processing by Spring Security.
	 */
	@Autowired
	 ...
	 * <li>Session management is set to {@link SessionCreationPolicy#STATELESS} as
	 * JWT tokens are used instead of HTTP sessions</li>
	 ...
	 * </p>
	 *
	 * @param http the {@link HttpSecurity} object used to configure web-based
	 *             security
